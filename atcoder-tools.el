...
(defun atcoder-tools--gen (contest-id)
  "Calls atcoder-tools gen to generate contest files."
  (async-shell-command (format "atcoder-tools gen %s" contest-id)))
...
;;;###autoload
(defun atcoder-tools-gen ()
  "Generate contest files using atcoder-tools"
  (interactive)
